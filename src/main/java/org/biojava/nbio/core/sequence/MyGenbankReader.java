 ...
 *
 */
public class MyGenbankReader<S extends AbstractSequence<C>, C extends Compound> {
     ...
     */
    public MyGenbankReader(final InputStream is, final SequenceHeaderParserInterface<S,C> headerParser,
     ...
     * You don't need to call {@link org.biojava.nbio.core.sequence.io.GenbankReader#close()} after calling this method.
     * @see #process(int)
